...
function startDaemon(argv) {
  ...
  function onMessage(message) {
    ...
    /*** Code to log uptime for naught process in naught.upt file ***/
    if(message.event=='WorkerDeath'){
      // WorkerDeath has occured, restart timestamp will be written in naught.upt file
      fs.writeFile(socketPath.replace("ipc","upt"), Date.now(), function (err) {
